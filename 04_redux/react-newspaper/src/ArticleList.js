		...
		return (
			<div className="app">
					...
					<div className="row">
						<div className="three columns">
							<button
								...
								onClick={this.openArticleModal.bind (this)}>
								+ Add Article
							</button>
						</div>
					...
					<div className="articles">
						{voidMsg}
						{
							articleList.map ((article) =>
								(
									<Article key={article.id} article={article} categories={this.props.categories}
													 voteArticle={this.voteArticle} updateArticle={this.updateArticle}
				...
				<Modal
					...
					contentLabel="Modal"
				>
					<ArticleModal title="Create Article" onCreateArticle={this.addArticle.bind (this)}
												categories={this.props.categories} closeArticleModal={this.closeArticleModal.bind (this)}/>
				</Modal>
