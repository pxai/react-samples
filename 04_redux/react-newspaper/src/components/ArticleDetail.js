			...
			<div className="article">
				...
				<div className="body">
					...
					<div className="articleData">
						...
						<span className="span-button"><a onClick={() => this.deleteArticle (article.id)}><i
							className="fa fa-trash"></i> delete</a></span>
						<span className="span-button">
             <a onClick={() => (this.voteArticle ("upVote"))} title="vote up"><i className="fa fa-thumbs-o-up"
																																								 aria-hidden="true"></i>Up</a>
             <a onClick={() => (this.voteArticle ("downVote"))} title="vote down"><i className="fa fa-thumbs-o-down"
																																										 aria-hidden="true"></i>Down</a>
          </span>
						<span className="span-button">
             <a onClick={this.openArticleModal.bind (this)}><i className="fa fa-pencil-square-o" aria-hidden="true"></i> Update</a>
				...
				<div className="comments">
					{comments.map ((comment) =>
						(
							<Comment key={comment.id} comment={comment} deleteComment={this.deleteComment.bind (this)}
											 openCommentModal={(comment) => this.openCommentModal (comment, true)}
				...
				<Modal
					...
					onRequestClose={this.closeCommentModal.bind (this)}
					contentLabel="Modal"
				>
					<CommentModal article={article} comment={this.state.comment} onCreateComment={this.addComment.bind (this)}
